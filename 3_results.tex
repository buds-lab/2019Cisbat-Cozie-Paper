...
\begin{figure}
\begin{center}
\includegraphics[width=0.5\textwidth, trim= 0cm 0cm 0cm 0cm,clip]{hourPlot.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.3\textwidth, trim= 0cm 0cm 0cm 0cm,clip]{response_rate.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.5\textwidth, trim= 0cm 0cm 0cm 0cm,clip]{cozie_users.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.5\textwidth, trim= 0cm 0cm 0cm 0cm,clip]{heartHist.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.5\textwidth, trim= 0cm 0cm 0cm 0cm,clip]{cozie_users_lowheart.pdf}
